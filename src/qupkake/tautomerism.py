...
class ComprehensiveTautomer:
    ...
    def __init__(self, smiles: str):
        ...
        with as_file(files('qupkake') / "smirks/smirks_transform_all.txt") as path:
    ...
    def _kekulized(self, rwm: Chem.Mol) -> list[Chem.Mol]:
        ...
        for _ in mols:
            ...
            try:
                ...
                continue
            _kekulized.append(Chem.MolFromSmiles(smi, ComprehensiveTautomer.ps))
        return _kekulized
...
if __name__ == '__main__':
    for smi in [
        ...
        t = ComprehensiveTautomer(smi).enumerate()
